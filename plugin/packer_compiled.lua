...
_G.packer_plugins = {
  ...
  ["neovim-session-manager"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/neovim-session-manager",
  ...
  tcomment_vim = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/tcomment_vim",
  ...
  ["telescope-live-grep-raw.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/telescope-live-grep-raw.nvim",
  ...
  ["vim-fswitch"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-fswitch",
