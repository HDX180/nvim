...
function! s:OnVimMessage(agent, body, ...) abort
  ...
  if a:body.method ==# 'gongfeng/new-version'
    if has('win32')
			echom "工蜂Copilot: New version found [" . a:body.params.version . "](" . a:body.params.distUrl . ")"
    else
      echom "工蜂Copilot: New version found [" . a:body.params.version . "],you can update by running: " . "curl -sL https://mirrors.tencent.com/repository/generic/gongfeng-copilot/vim/install.sh | sh"
		endif
  endif
endfunction
